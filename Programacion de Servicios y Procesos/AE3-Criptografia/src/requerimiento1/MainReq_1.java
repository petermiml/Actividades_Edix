...
public class MainReq_1 {
	...
	public static void main(String[] args) throws IOException{
		...
		// ================ Creamos la clave sim�trica ======================
		try {
			// Creamos el objeto que genera la clave sim�trica e indicamos que usar� el algoritmo DES
			generador = KeyGenerator.getInstance("DES");
			
			// Creamos la clave sim�trica y la almacenamos en "claveSimetrica" que es un objeto de tipo SecretKey
		...
		do {
			...
			System.out.println("Indica qu� deseas hacer:\n");
